  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        "glow": {
          "0%, 100%": { boxShadow: "0 0 5px hsl(var(--neon-blue) / 0.5), 0 0 10px hsl(var(--neon-blue) / 0.3)" },
          "50%": { boxShadow: "0 0 15px hsl(var(--neon-blue) / 0.8), 0 0 30px hsl(var(--neon-blue) / 0.5)" },
        },
      },
      animation: {
